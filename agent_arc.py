from smolagents import CodeAgent, AzureOpenAIModel, E2BExecutor, tool, AgentLogger
import os
...
@tool
def clinical_calculator(calculation_type: str, **params: Any) -> str:
    """
...
agent = CodeAgent(
    ...
    executor=E2BExecutor(
        additional_imports=["pandas", "numpy", "scipy"],
        logger=logger
    ),  # Remote secure execution for GAIA tasks
